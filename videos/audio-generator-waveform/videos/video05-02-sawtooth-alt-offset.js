/*    video05-02-sawfrom-alt-offset - for audio-generator-waveform project
...
VIDEO.init = function(sm, scene, camera){
    ...
    sq.objects[0] = {
        ...
        for_frame: (fs, frame, max_frame, a_sound2, opt, a_object, sq) => {
            ...
            saw_samps(fs.array_wave, 100, a_sound2, pa_1, false, 0.75 * a_object);
            saw_samps(fs.array_wave, 100, a_sound2, pa_2, true, 0);
            return fs;
        },
