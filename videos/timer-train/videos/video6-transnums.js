...
VIDEO.init = function(sm, scene, camera){
    ...
    .then( (scene_source) => {
        ...
        const land = scene_source.getObjectByName('trainset_land');
        ...
        TRAIN_CARS.forEach((ti)=>{
            const mesh_source = scene_source.getObjectByName('train_car_' + ti);
        ...
        const LANDSCAPE_DATA = [ 
            ...
            1,  5.50, -0.30,  6.75,  3.00,
            1,  5.50, -0.30, -7.60,  3.50,
            ...
            0, -9.30, -0.30,  8.60,  0.00,
            0, -0.70,  0.00, -8.50,  0.00,
            0,  2.70,  0.00, -9.50,  0.00
        ];
        ...
        while(i < len){
            ...
            const mesh = scene_source.getObjectByName('landscape_' + objIndex).clone();
