/*    video01-13-original-bass2 - for audio-generator-tune-seededrandom project
          * just a simple bass beat
 */
VIDEO.resmode = 6;
//-------- ----------
// THUM
...
VIDEO.init = function(sm, scene, camera){
    ...
    const patt_bass_1 = [
        1,'c1',1,'c1',0.5,'c1',0.5,'c1',0.5,'d1',0.5,'e1'
    ];

    const patt_bass_2 = [
        1,'c1',1,'c1',0.5,'c1',0.5,'c1',0.25,'d1',0.25,'e1',0.25,'d1',0.25,'e1'
    ];
    ...
    const patt_bass2_2 = [
        1,'g1',1,'g1',0.5,'g1',0.5,'g1',0.5,'a1',0.5,'b1'
    ];

    const patt_bass2_3 = [
        1,'g1',1,'g1',0.5,'g1',0.5,'g1',0.25,'a1',0.25,'b1',0.25,'a1',0.25,'b1'
    ];
    ...
    const tune_1 = [
        patt_bass_1, patt_bass_2, patt_bass_1, patt_bass_2,
        patt_bass_1, patt_bass_2, patt_bass_1, patt_bass_2,
    ].flat();

    const tune_2 = [
        patt_bass2_1,patt_bass2_1,patt_bass2_2,patt_bass2_3,
        patt_bass2_1,patt_bass2_1,patt_bass2_1,patt_bass2_1
    ].flat();
    ...
    sq.objects[1] = {
        ...
        for_sampset: function(samp, i, a_sound, opt, a_object, sq){
            ...
            samp1.amplitude = ST.get_tune_amp(samp1.frequency, obj_1.a_wave, 0.10, 1.00);
            samp1.int_shift = 0;
            samp1.values_per_wave = 5 + 45 * a_object;     
            samp.samp1 = samp1;
            ...
            samp2.amplitude = ST.get_tune_amp(samp2.frequency, obj_2.a_wave, 0.10, 1.00);
            samp2.int_shift = 0;
            samp2.values_per_wave = 5 + 45 * a_object;       
            samp.samp2 = samp2;
