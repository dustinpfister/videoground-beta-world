/*    video01-08-original-fast-track - for audio-generator-tune-seededrandom project
          * want to try one that is a few patterns that are fast paced
 */
VIDEO.resmode = 6;
//-------- ----------
// THUM
//-------- ----------
VIDEO.name = 'FAST-TRACK';
VIDEO.thum_frame = 0;
...
VIDEO.init = function(sm, scene, camera){
    ...
    const patt_1 = [
        2,'e2',0.25,'f1',0.25,'f1',0.25,'f1',0.25,'f1',
        2,'e2',0.25,'f1',0.25,'f1',0.25,'f1',0.25,'f1',
        2,'e2',0.25,'f1',0.25,'f1',0.25,'f1',0.25,'f1',
        2,'e2',4,'b2'
    ];
    ...
    const patt_2 = [
        0.25,'f2',0.25,'e2',0.25,'d2',0.25,'c2',0.25,'b1',0.25,'b1',0.25,'b1',0.25,'b1',0.25,'b1',0.25,'b1',0.25,'b1',0.25,'b1',
        0.25,'a1',0.25,'a1',0.25,'a1',0.25,'a1',0.25,'a1',0.25,'a1',0.25,'a1',0.25,'a1',0.25,'a1',0.25,'a1',0.25,'a1',0.25,'a1',
        0.25,'f2',0.25,'f2',0.25,'f2',0.25,'f2',0.25,'f2',0.25,'f2',0.25,'f2',0.25,'f2',0.25,'f2',0.25,'f2',0.25,'f2',0.25,'f2',
        0.25,'c2',0.25,'c2',0.25,'c2',0.25,'c2',0.25,'c2',0.25,'c2',0.25,'c2',0.25,'c2',0.25,'c2',0.25,'c2',0.25,'c2',0.25,'c2',
        0.25,'a1',0.25,'a1',0.25,'b1',0.25,'b1',0.25,'b1',0.25,'a1',0.25,'a1',0.25,'b1',0.25,'c2',0.25,'d2',0.25,'e2',0.25,'f2'
    ];
    ...
    sq.objects[0] = {
        ...
        for_sampset: function(samp, i, a_sound, opt, a_object, sq){
            ...
            samp.amplitude = ST.get_tune_amp(samp.frequency, obj_1.a_wave, 0.05, 0.50);

            samp.int_shift = 0;
            
            const a_vpw= ST.get_alpha(obj_1.a_wave, 1, 1 );
            samp.values_per_wave = 10 + Math.round(20 + 60 * a_object * a_vpw);
