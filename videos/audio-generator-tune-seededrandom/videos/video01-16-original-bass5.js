/*    video01-16-original-bass5 - for audio-generator-tune-seededrandom project
          * Going a bit farther with what I started in bass4
          * At least 3 patterns for bass1
 */
VIDEO.resmode = 6;
//-------- ----------
// THUM
...
VIDEO.init = function(sm, scene, camera){
    ...
    const patt_bass1_1 = [ // 8 beats
        4,'c1',1,'e1',1,'e1',2,'f1'
    ];

    const patt_bass1_2 = [ // 8 beats
        0.5,'c1',0.5,'c1',0.5,'c1',0.5,'c1',0.5,'c1',0.5,'c1',0.5,'c1',0.5,'c1',1,'e1',1,'e1',2,'f1'
    ];

    const patt_bass1_3 = [ // 8 beats
        2,'c1', 0.5,'e1',0.5,'e1',0.5,'e1',1,'f1',0.5,'e1',0.5,'f1',0.5,'e1',3,'c1'
    ];



    const tune_1 = [
       patt_bass1_1, patt_bass1_1, patt_bass1_2, patt_bass1_2, patt_bass1_3, patt_bass1_2
    ].flat();
