/*    video01-15-original-bass4 - for audio-generator-tune-seededrandom project
          * just a simple bass line, yet again
          * this time nothing fancy just working out a beat with some spacing
 */
VIDEO.resmode = 6;
//-------- ----------
// THUM
...
VIDEO.init = function(sm, scene, camera){
    ...
    const tune_1 = [
       patt_bass1_1,patt_bass1_1,patt_bass1_1,patt_bass1_1
    ].flat();
    ...
    sq.objects[1] = {
        ...
        for_sampset: function(samp, i, a_sound, opt, a_object, sq){
            const a_freq = 1.00;
            const vpw = 20;
            const space = 0.10 + 0.85 * a_object;
            const amp = 0.65
            samp.samp1 = get_samp(data_1, a_object, vpw, a_freq, space, amp);
            return samp
        }
